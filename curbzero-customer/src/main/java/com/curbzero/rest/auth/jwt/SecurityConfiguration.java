package com.curbzero.rest.auth.jwt;
...
import com.curbzero.rest.auth.jwt.resource.MyUserDetailsService;
...
/*		BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder();
		String encode = bCryptPasswordEncoder.encode("dummy");*/
	...
	public static void main(String arg[]) {
		...
		for(int i=0;i<10;i++) {
			String encode = bCryptPasswordEncoder.encode("srikanthi");
